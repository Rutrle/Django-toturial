...
class Product(models.Model):
    ...
    featured = models.BooleanField() # new field, possibilities: 1) delete database and make new one, 2) null = True -> in all old data this field will be empty 3) default = True => sets default value  to the value given 4) give info to python during  making migrations